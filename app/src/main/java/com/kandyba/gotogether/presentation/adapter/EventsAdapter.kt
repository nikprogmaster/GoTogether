...
import com.kandyba.gotogether.models.general.Probability
...
class EventsAdapter(
        ...
        fun bindViews(event: EventModel) {
            ...
            likeButton.setOnClickListener {
                listener.onLikeButtonClick(
                    event.id,
                    if (likeButton.isChecked) Probability.LIKED else Probability.DISLIKED
                )
            }
        }
    }
    ...
    interface OnEventClickListener {
        ...
        fun onLikeButtonClick(eventId: String, probability: Probability)
    }
