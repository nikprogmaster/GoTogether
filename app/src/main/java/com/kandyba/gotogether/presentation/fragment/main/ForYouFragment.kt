...
class ForYouFragment : Fragment() {
    ...
    private val eventClickListener = object : EventsAdapter.OnEventClickListener {
    ...
    private fun initEventsAdapter(events: List<EventModel>) {
        eventsAdapter = EventsAdapter(events.toMutableList(), eventClickListener)
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        viewModel?.eventsRecommendations?.removeObservers(requireActivity())
